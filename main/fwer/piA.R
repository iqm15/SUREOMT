...
param.list <- fromJSON(file = "../../config/fwer/piA.json")  
# -----------------------------------------------------------------------
...
file_name_data_power = gsub(" " , "", paste("../../data/fwer/piA/", gsub(" ", "_", paste("data_power", param.list$param_interest, "study", now(), sep="_")), ".csv"))
file_name_data_fwer = gsub(" " , "", paste("../../data/fwer/piA/", gsub(" ", "_", paste("data_fwer", param.list$param_interest, "study", now(), sep="_")), ".csv"))
